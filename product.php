				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Tk '.$row['product_price'].'<del class="product-old-price">Tk 990.00</del></h3>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Sourav</h5>
															<p class="date">15 May 2021, 11:17 AM</p>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Shuvo</h5>
															<p class="date">10 May 2021, 8:22 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Mitu</h5>
															<p class="date">09 May 2021, 09:15 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
